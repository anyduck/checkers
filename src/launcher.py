...
from PySide2.QtCore import QSize, QRect, QPropertyAnimation, QParallelAnimationGroup, Qt, QTimer
...
"QLineEdit {border: 1px solid rgb(240, 240, 240);}")
    ...
    def startMulti(self):
        try:
            ...
            self.StartMultiplayer.clicked.disconnect()
            self.StartMultiplayer.setText("Server Offline")
            QTimer().singleShot(5000, self.doMenu)
